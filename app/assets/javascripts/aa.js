...
var filterMedicalConditions = function(selector){
  ...
  $.get("/admin/medical_condition_names.json?utf8=%E2%9C%93&q%5Bmedical_condition_type_id_eq%5D=" + type_id + "&commit=Filter&order=id_desc", "", function(data){ narrowList(data, $nameSelect); }, "json");
}
